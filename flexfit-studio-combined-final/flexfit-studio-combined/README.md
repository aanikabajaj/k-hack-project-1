...
This is the merged project — the member/booking refactor and the staff/admin/corporate
refactor, built independently by a two-person team, combined into one codebase. See the
top-level [`README.md`](../../README.md) for team credit and a summary of what changed, and
[`documents/changelog-2026-08-14.md`](documents/changelog-2026-08-14.md) for the full write-up.
