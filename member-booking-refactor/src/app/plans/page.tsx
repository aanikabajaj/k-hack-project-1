...
export default function PlansPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {subscribe.error && <ErrorBanner message={subscribe.error.message} />}
      {subscribe.isSuccess && <SuccessBanner message="Membership activated." />}
        ...
        {plans?.map((p) => (
          <div key={p.id} className="panel flex flex-col gap-3 p-5">
            ...
            <p className="muted text-sm">
              ...
              {p.classCredits >= UNLIMITED_CREDITS
                ? "Unlimited classes"
